...
namespace net {
    QuicServerConnection::QuicServerConnection(net::ipv4::SockAddr_In sockAddr, bool listener) : recvLooper_(std::bind(&QuicServerConnection::RecvLoop, this)),
                                                                                                                      sendLooper_(std::bind(&QuicServerConnection::SendLoop, this)),
                                                                                                                      conn_(NULL) {
...
/*if (getenv("SSLKEYLOGFILE")) {
    ...
    void QuicServerConnection::RecvLoop() {
        uint8_t buf[65535];
    ...
    void QuicServerConnection::SendLoop() {
        uint8_t out[MAX_DATAGRAM_SIZE];
