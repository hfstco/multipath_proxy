...
TEST(net_Flow, write_to_connection_sorted) {
    std::thread t1([&] {
        ...
        packet::header::FlowHeader flowHeader1 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 1);
        packet::FlowPacket *pFlowPacket1 = packet::FlowPacket::make(flowHeader1, vector1.data(), 2);
        packet::header::FlowHeader flowHeader2 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 2);
        packet::FlowPacket *pFlowPacket2 = packet::FlowPacket::make(flowHeader2, vector1.data() + 2, 2);
        packet::header::FlowHeader flowHeader3 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 3);
        packet::FlowPacket *pFlowPacket3 = packet::FlowPacket::make(flowHeader3, vector1.data() + 4, 2);
        packet::header::FlowHeader flowHeader4 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 4);
        packet::FlowPacket *pFlowPacket4 = packet::FlowPacket::make(flowHeader4, vector1.data() + 6, 2);
        packet::header::FlowHeader flowHeader5 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 5);
        packet::FlowPacket *pFlowPacket5 = packet::FlowPacket::make(flowHeader5, vector1.data() + 8, 2);
        packet::header::FlowHeader flowHeader6 = packet::header::FlowHeader(sourceSockAddrIn, destinationSockAddrIn, 6);
        packet::FlowPacket *pFlowPacket6 = packet::FlowPacket::make(flowHeader6, vector1.data() + 10, 1);

        packet::header::FlowHeader flowCloseHeader1 = packet::header::FlowCloseHeader(sourceSockAddrIn, destinationSockAddrIn, 7);
